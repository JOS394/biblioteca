...
return [
    ...
    'exists'               => 'El :attribute no se encuentra registrado en el sistema.',
    ...
    'attributes'           => [
        ...
        'title'                 => 'título',
        'username'              => 'usuario',
        'nom_activo'            => 'Nombre del activo',
        'marca_act'             => 'Marca del activo',
        'ubicacion_act'         => 'Ubicacion del activo',
        'encargado_act'         => 'Encargado del activo',
        'categoria_activo'      => 'Categoria del activo',
        'codigo_activo'         => 'Codigo de activo',
        'estado_activo'         => 'Estado del activo',
        'foto'                  => 'foto del activo',
        'dominio'               => 'Dominio del activo',
        'descripcion'           => 'Descripcion del activo',
        'repassword'            => 'Repetir Contraseña',
        'nom_completo'          => 'Nombre completo',
        'nom_categoria'          => 'Nombre de categoria',
